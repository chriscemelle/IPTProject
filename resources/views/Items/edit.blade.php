...
<div style="width: 900px;" class="container max-w-full mx-auto pt-4">
    ...
    <form method="post" action="/items/{{ $item->id }}">
        ...
        <button class="bg-blue-500 btn-info tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow">Update</button>
        <a href="/items" class="bg-gray-500 btn-info tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow">Cancel</a>
    </form>
</div>
